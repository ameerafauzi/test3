  ...
  var quickShop = {
    init: function(){
      ...
      $('body').on('opened', '.js-quick-shop', function () {
        ...
        var availability = JSONData.available;
        var available = JSONData.variants[0].sku;
        // meekco
      ...
      success: function (data) {
        ...
        if(quantity > 0 && quantity != updated_quantity) {
          if (updated_quantity == 1) {
            items_left_text = "copy left";
          } else {
            items_left_text = "copies left";
          }
